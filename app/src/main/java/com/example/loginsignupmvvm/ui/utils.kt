package com.example.loginsignupmvvm.ui
...
import com.example.loginsignupmvvm.ui.auth.LoginFragment
    ...
    when {
        ...
        failure.errorCode == 401->{
            if (this is LoginFragment){
                requireView().snackBar("You've entered inconrrect email or password")
            }
        }else ->{
